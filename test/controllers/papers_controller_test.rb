...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { address: @paper.address, month: @paper.month, publisher: @paper.publisher, title: @paper.title, url: @paper.url, year: @paper.year }
    end
  ...
  test "should update paper" do
    patch :update, id: @paper, paper: { address: @paper.address, month: @paper.month, publisher: @paper.publisher, title: @paper.title, url: @paper.url, year: @paper.year }
    assert_redirected_to paper_path(assigns(:paper))
  end
