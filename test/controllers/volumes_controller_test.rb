...
class VolumesControllerTest < ActionController::TestCase
  ...
  test "should create volume" do
    assert_difference('Volume.count') do
      post :create, volume: { address: @volume.address, month: @volume.month, publisher: @volume.publisher, url: @volume.url, year: @volume.year }
    end
  ...
  test "should update volume" do
    patch :update, id: @volume, volume: { address: @volume.address, month: @volume.month, publisher: @volume.publisher, url: @volume.url, year: @volume.year }
    assert_redirected_to volume_path(assigns(:volume))
  end
